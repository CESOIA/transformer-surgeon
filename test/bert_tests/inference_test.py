...
def build_dataloader(task: str, tokenizer, batch_size: int):
    """
    GLUE:
      - MNLI: use validation_matched by default; label is "label"
      - QNLI: use validation; label is "label"
    Input fields:
...
def main():
    ...
    parser.add_argument("--task", choices=["mnli", "qnli"], default="mnli")
